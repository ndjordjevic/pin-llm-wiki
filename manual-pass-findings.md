...
3. **Topic page creation trigger** — should lint *suggest* topic pages (report only) or *create stubs* (auto-fix)? Current plan says lint reports, fixes are user-driven. But stub creation seems safe enough to automate.
